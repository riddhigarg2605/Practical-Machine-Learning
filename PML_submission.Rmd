...
```{r}
testcsv <- read.csv("/Users/riddhi/Downloads/pml-training.csv")
traincsv <- read.csv("/Users/riddhi/Downloads/pml-testing.csv")
dim(traincsv)
dim(testcsv)
```
...
inTrain <- caret::createDataPartition(y=traincsv$classe,p=0.70,list=FALSE);
